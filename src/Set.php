...
final class Set extends AbstractValue implements \Countable, \Stringable
{
     ...
     *
     * @param AbstractValue ...$sets One or more Sets
     */
    public function union(AbstractValue ...$sets): self
    {
        $union = $this->value;
     ...
     * @param AbstractValue ...$sets One or more Sets
     */
    public function intersect(AbstractValue ...$sets): self
    {
     ...
     * @param AbstractValue ...$sets One or more Sets
     */
    public function complement(AbstractValue ...$sets): self
    {
     ...
     * passed Set.
     */
    public function symmetricDifference(AbstractValue $set): self
    {
