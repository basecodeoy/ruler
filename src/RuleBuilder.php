...
final class RuleBuilder implements \ArrayAccess
{
     ...
     */
    public function create(Proposition $proposition, $action = null): Rule
    {
        return new Rule($proposition, $action);
    }
     ...
     *
     * @param Proposition ...$proposition One or more Propositions
     */
    public function logicalAnd(Proposition ...$proposition): Operator\LogicalAnd
    {
        return new Operator\LogicalAnd($proposition);
    }
     ...
     * @param Proposition ...$proposition One or more Propositions
     */
    public function logicalOr(Proposition ...$proposition): Operator\LogicalOr
    {
        return new Operator\LogicalOr($proposition);
    }

    /**
     * Create a logical NOT operator proposition.
     *
     * @param Proposition $proposition Exactly one Proposition
     */
    public function logicalNot(Proposition $proposition): Operator\LogicalNot
    {
        return new Operator\LogicalNot([$proposition]);
    }
     ...
     * @param Proposition ...$proposition One or more Propositions
     */
    public function logicalXor(Proposition ...$proposition): Operator\LogicalXor
    {
        return new Operator\LogicalXor($proposition);
    }
